...
public class BaseAspect {
    ...
    public static final String BEFORE_CONTROLLER_PATTERN = PREFIX_CONTROLLER_BEFORE + " {} " + " {}: " + URI + " {}," + ARGS + " {} ";
    public static final String AFTER_CONTROLLER_PATTERN = PREFIX_CONTROLLER_AFTER + " {} " + " {}: " + URI + " {}, result is {}," + ARGS + " {} ";
